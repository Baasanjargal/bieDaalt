...
public class Desert extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		switch(position) {
			case 0: startActivity(new Intent(this, Pirog.class)); break;
			case 1: startActivity(new Intent(this, Sharlotka.class)); break;
			case 2: startActivity(new Intent(this, Chiher.class)); break;
		}
	}
}